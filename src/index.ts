...
import backupRoutes from './routes/backup.routes'; // <-- Impor rute backup baru
...
// Halaman-halaman baru yang disajikan setelah login
...
app.get('/backups', (req: Request, res: Response) => {
    res.sendFile(path.join(rootPath, 'src', 'views', 'backups.html'));
});
// ==========================================================
...
app.use('/api', backupRoutes); // Daftarkan rute API backup
