...
interface BackupFile { uniqueName: string; originalName: string; createdAt: string; }
...
export const BackupList = () => {
    ...
    useEffect(() => {
        // ... (logika fetch data tetap sama seperti di BackupView sebelumnya) ...
        const fetchBackups = async () => {
            ...
            try {
                ...
                if (!rspaceRes.ok || !perpuskuRes.ok) throw new Error('Gagal memuat data cadangan.');
