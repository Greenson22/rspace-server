...
export const UserManagement = () => {
    ...
    return (
        <Card>
            <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6">Manajemen Pengguna (Admin)</h2>
                ...
                <div className="overflow-x-auto border rounded-md">
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {users.map((user) => (
                                <tr key={user.id}>
                                    <td className="px-4 md:px-6 py-4 whitespace-nowrap text-sm text-gray-900">{user.name}</td>
                    ...
                    {users.length === 0 && <p className="text-center mt-4 p-4 text-gray-500">Tidak ada pengguna lain.</p>}
                </div>
            )}
        </Card>
    );
